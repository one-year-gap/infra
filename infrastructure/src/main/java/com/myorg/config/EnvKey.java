...
public enum EnvKey {
    ...
    ON_DEMAND_FASTAPI_SERVICE_ARN,
    ON_DEMAND_FASTAPI_SERVICE_NAME,
    ON_DEMAND_FASTAPI_TARGET_GROUP_ARN,
    ON_DEMAND_FASTAPI_SECURITY_GROUP_ID,
    ON_DEMAND_READY_URL,
    ...
    ON_DEMAND_WORKER_BATCH_JOB_NAME("testJob"),
    ...
    ON_DEMAND_WORKER_IMAGE_TAG_PREFIX,

    ON_DEMAND_READY_PROBE_VPC_ID,
    ON_DEMAND_READY_PROBE_SECURITY_GROUP_ID,
    ON_DEMAND_READY_PROBE_SUBNET_IDS,
    ON_DEMAND_READY_PROBE_TIMEOUT_SECONDS,
    ON_DEMAND_READY_RETRY_INTERVAL_SECONDS,
    ON_DEMAND_READY_MAX_ATTEMPTS,
    ON_DEMAND_READY_BACKOFF_RATE,
    ON_DEMAND_READY_REQUIRED_CHECKS,
    ON_DEMAND_EXPECTED_RELEASE_TAG,
    ON_DEMAND_FASTAPI_IMAGE_TAG_PREFIX,
    ON_DEMAND_ENABLE_RELEASE_CHECK,

    ON_DEMAND_SCALE_UP_DESIRED_COUNT,
    ON_DEMAND_SCALE_DOWN_DESIRED_COUNT,
    ON_DEMAND_STEADY_POLL_SECONDS,
    ON_DEMAND_STEADY_MAX_ATTEMPTS,
    ON_DEMAND_ALB_HEALTH_POLL_SECONDS,
    ON_DEMAND_ALB_HEALTH_MAX_ATTEMPTS,

    ON_DEMAND_ENFORCE_ISOLATION_GUARD,
    ON_DEMAND_RDS_SECRET_ARN,
    ON_DEMAND_RDS_SECURITY_GROUP_ID,
    ON_DEMAND_ENFORCE_SEPARATE_EFS_ACCESS_POINTS,
    ON_DEMAND_FASTAPI_EFS_ACCESS_POINT_ID,
    ON_DEMAND_WORKER_EFS_ACCESS_POINT_ID,

    ON_DEMAND_ENABLE_BUSINESS_VALIDATION,
    ON_DEMAND_BUSINESS_MIN_PROCESSED_COUNT,
    ON_DEMAND_BUSINESS_REQUIRED_RESULT_FILES,

    ON_DEMAND_ENABLE_WATCHDOG,
    ON_DEMAND_WATCHDOG_SCHEDULE_EXPRESSION,
    ON_DEMAND_WATCHDOG_IDLE_MINUTES,

    ON_DEMAND_READY_PROBE_LAMBDA_ASSET_PATH,
    ON_DEMAND_RUNTIME_GUARD_LAMBDA_ASSET_PATH,
    ON_DEMAND_BUSINESS_VALIDATOR_LAMBDA_ASSET_PATH,
    ON_DEMAND_WATCHDOG_LAMBDA_ASSET_PATH,
    ON_DEMAND_READY_PROBE_MEMORY_MB,
    ON_DEMAND_RUNTIME_GUARD_MEMORY_MB,
    ON_DEMAND_BUSINESS_VALIDATOR_MEMORY_MB,
    ON_DEMAND_WATCHDOG_MEMORY_MB,
