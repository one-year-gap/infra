...
public enum EnvKey {
    ...
    ON_DEMAND_WORKER_KAFKA_SECURITY_PROTOCOL("SASL_SSL"),
    ON_DEMAND_WORKER_KAFKA_SASL_MECHANISM("AWS_MSK_IAM"),
    ON_DEMAND_WORKER_KAFKA_SASL_JAAS_CONFIG("software.amazon.msk.auth.iam.IAMLoginModule required;"),
    ON_DEMAND_WORKER_KAFKA_SASL_CALLBACK_HANDLER_CLASS("software.amazon.msk.auth.iam.IAMClientCallbackHandler"),
